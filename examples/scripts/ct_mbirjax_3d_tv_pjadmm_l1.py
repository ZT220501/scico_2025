...
def pjadmm_test(Nx=128, Ny=256, Nz=64, row_division_num=2, col_division_num=2, do_block_recon=True):
    ...
    if do_block_recon:
        ...
        save_path = os.path.join(os.path.dirname(__file__), f'results/pjadmm_l1_{row_division_num}_{col_division_num}')
        ...
        tangle_recon = np.load(os.path.join(os.path.dirname(__file__), f'results/pjadmm_l1_{row_division_num}_{col_division_num}/x_all.npy'))
    ...
    results_dir = os.path.join(os.path.dirname(__file__), f'results/pjadmm_l1_{row_division_num}_{col_division_num}')
    os.makedirs(results_dir, exist_ok=True)
    save_path = os.path.join(results_dir, f'ct_mbirjax_3d_tv_pjadmm_l1_recon_{n_projection}views_regularization_{tv_weight}.png')
