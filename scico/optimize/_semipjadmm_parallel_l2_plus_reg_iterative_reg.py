...
class ParallelSemiProxJacobiADMML2PlusRegIterativeReg(Optimizer):
    ...
    def __init__(
        ...
        maxiter_pdhg: int = 5,
        τ_pdhg: float = 2e-2,            # Default parameters for PDHG.
        σ_pdhg: float = 8e0,         # Default parameters for PDHG.
        ...
        **kwargs,
        ...
        self.τ_pdhg: float = τ_pdhg                      # Proximal weight for PDHG.
        self.σ_pdhg: float = σ_pdhg                      # Dual weight for PDHG.
        ...
        def _make_x_update_fn(A_i, g_i, C_i):
            ...
            def x_update_single(x_i, Ax_i, z_i, λ_i, τ):
                ...
                solver_pdhg = PDHG(
                    ...
                    C = C_i,
                    tau=self.τ_pdhg,           # Default parameters for PDHG.
                    sigma=self.σ_pdhg,           # Default parameters for PDHG.
                    x0=x_i,
        ...
        self._x_update_fns = [_make_x_update_fn(Ai, gi, Ci) 
                               for Ai, gi, Ci in zip(self.A_list, self.g_list, self.C_list)]
    ...
    def _itstat_extra_fields(self):
        ...
        itstat_fields = {"Prml Rsdl": "%9.3e", "Dual Rsdl": "%9.3e", "Regularization": "%9.3e", "Constraint": "%9.3e", "Proximal Parameter": "%9.3e", "x difference": "%9.3e"}
        itstat_attrib = ["norm_primal_residual()", "norm_dual_residual()", "regularization_value()", "constraint_value()", "proximal_parameter()", "x_difference()"]
